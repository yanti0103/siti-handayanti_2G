    ...
    <div class="container bg-light p-5" style="border-radius: 20px;">
        <div class="row my-5">
            <div class="col-md-6 d-flex align-items-center">
                <div>
                    <h2>Selamat Datang di Mahakomputer <br><b>Komputer dan Laptop</b></h2>
                    <p class="text-secondary">Tempat berkumpulnya Berbagai Macam-macam Komputer Dan Laptop, <br>Marilah Berkunjung Di Mahakomputer</p>
